 ...
 * 3.create stripe account and get publishble key
 * 4.use publishable key and use stripe to get card information and error
 * 5.create payment intent post on the server and return client secrete
 * install stripe on the server side and get client secrete.make sure you used the payment method types: ['card']
